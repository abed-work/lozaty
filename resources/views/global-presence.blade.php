		...
		<div class="m_v_b" style="min-height: 100vh;">
			...
			<div id="bc">
				...
				<div id="header" style="background: URL('https://www.lozaty.com/s/i/bg.jpg') scroll repeat center center/cover; direction: ltr; padding: 100px 0px; padding-top: 141px;">
					...
					<div class=ov style="background: rgba(255,255,255,0.2);"></div><span class=fh><div class=pageTit><h3>Global Presence</h3></div><nav aria-label="breadcrumb"><ol class="breadcrumb site-breadcumb-1 justify-content-center"><li class="breadcrumb-item"><a href="https://www.lozaty.com/">Home</a></li><li class="breadcrumb-item active" aria-current="page">Global Presence</li></ol></nav></span></div>
